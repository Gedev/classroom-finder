...
Route::post('storeAnnouncement', 'AnnouncementController@store')->name('storeAnnouncement');
...
Route::middleware('roleVerification')->group(function () {
    ...
    Route::get('/attendance', 'HomeController@attendanceRecord')->name('attendanceRecord');
